...
import com.SeyaCloudGestion.GestionSistema.feacture.codigoBarras.infraestructure.persistence.repository.crud.CodigoBarraDetalleRepository;
...
@Service
@Slf4j
public class CodigoBarraService implements ICodigoBarraRegistro, ICodigoBarraListado, ICodigoBarraEdicion, ICodigoBarraDetalle {
    ...
    private final CodigoBarraDetalleRepository codigoBarraDetalleRepository;

    public CodigoBarraService(CodigoBarraRegistroRepository codigoBarraRegistroRepository, CodigoBarraListadoRepository codigoBarraListadoRepository, CodigoBarraEdicionAllRepository codigoBarraEdicionAllRepository, CodigoBarraDetalleRepository codigoBarraDetalleRepository) {
        ...
        this.codigoBarraDetalleRepository = codigoBarraDetalleRepository;
    }

    @Override
    @Cacheable(value = "codigoBarras_lista")
    ...
    @Override
    @CacheEvict(value = {"codigoBarras_lista"}, allEntries = true)
    public ResponseEditarAllCodigoBarra EditarAllCodigoBarra(RequestEditarAllCodigoBarra request,long id) {
        return codigoBarraEdicionAllRepository.EditarAllCodigoBarra(request,id);
    }

    @Override
    public ResponseDetalleCodigoBarra DetalleCodigoBarra(RequestDetalleCodigoBarra request) {
        return codigoBarraDetalleRepository.DetalleCodigoBarra(request);
    }
}
